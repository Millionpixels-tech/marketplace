  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col">
      ...
      <main className="flex flex-1 items-center justify-center">
        <div className="w-full max-w-sm px-6 py-10 bg-white rounded-3xl shadow-lg flex flex-col gap-6">
          ...
          >
            ...
            <button
              type="button"
              disabled={loading}
              className="flex items-center justify-center gap-3 bg-white border border-[#45495522] text-[#454955] rounded-2xl py-3 text-lg font-semibold shadow-sm hover:bg-gray-50 transition"
