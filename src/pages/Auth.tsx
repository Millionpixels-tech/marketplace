  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col">
      ...
      <main className="flex flex-1 items-center justify-center">
        <div className="w-full max-w-sm px-6 py-10 bg-white rounded-3xl shadow-2xl flex flex-col gap-6">
          ...
          >
            ...
            <button
              type="button"
              disabled={loading}
              className="flex items-center justify-center gap-3 bg-white border border-black/20 text-black rounded-xl py-3 text-lg font-semibold shadow hover:bg-gray-50 transition"
          ...
          <div className="text-center text-sm text-gray-500">
            {isLogin ? (
              <>
                ...
                <button
                  type="button"
                  className="underline font-semibold text-black hover:text-blue-700 transition"
