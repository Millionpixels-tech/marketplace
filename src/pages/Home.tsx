          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 w-full">
            {Array.from({ length: 10 }).map((_, i) => (
              ...
              >
                ...
                <h3 className="font-semibold text-lg mb-2">Sample Product {i + 1}</h3>
                <p className="text-sm font-light mb-2 text-gray-700">Product description goes here.</p>
                <span className="font-bold text-black">Rs. {(i + 1) * 400}.00</span>
              </div>
            ))}
          </div>
        </div>
